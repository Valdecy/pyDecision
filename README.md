# pyDecisions
A python MCDA Library having the following methods: **AHP** (Analytic Hierarchy Process), **ELECTRE** (I, I_s, I_v, II, III, IV, Tri-B); **PROMETHEE** (I, II, III, IV, V, VI, Gaia); **TOPSIS** (Technique for Order of Preference by Similarity to Ideal Solution); **VIKOR** (VIseKriterijumska Optimizacija I Kompromisno Resenje).
